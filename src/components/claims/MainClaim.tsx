...
const MainClaim: React.FC = () => {
  ...
  const mainClaimResults = useSelector(
  ...
  useEffect(() => {
    ...
    setFutureInterestBasic(futureInterestBasicCalc);
    ...
    const cancelledFutureInterestCalc =
      futureInterestBasicCalc - futureInterestMainClaimCalc;
          ...
          <table className="min-w-full bg-white border border-gray-300">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="py-2 px-4 border text-right">
                  {formatNumber(totalInterestMainClaim)}
                </td>
              </tr>
              <tr className="bg-gray-50">
                <td className="py-2 px-4 border">
                ...
                <td className="py-2 px-4 border text-right">
                  {formatNumber(futureInterestBasic)}
                </td>
              </tr>
              <tr>
